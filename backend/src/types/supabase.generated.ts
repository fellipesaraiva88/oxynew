  ...
  public: {
    Tables: {
      ...
      ai_response_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_response_templates_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "dashboard_metrics"
            referencedColumns: ["organization_id"]
      ...
      organization_settings: {
        Row: {
          ...
          ai_config: Json | null
          ai_onboarding_completed: boolean | null
          ai_personality_config: Json | null
          ai_response_style: Json | null
